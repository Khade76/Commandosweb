  ...
  return (
    <header className={`site-header ${scrolled ? 'scrolled' : ''}`}>
      <div className="shell nav-shell">
        <Link className="brand" to="/"><img src={images.mark} alt="44th mark" /><span><strong>44TH COMMANDO REGIMENT</strong><small>WARDOGS COMMUNITY</small></span></Link>
        <button className="menu-toggle" type="button" aria-label="Toggle navigation" onClick={() => setOpen(!open)}><span /><span /><span /></button>
