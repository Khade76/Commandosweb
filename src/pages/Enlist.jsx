...
const steps = [
  ...
  ['02', 'Introduce yourself', 'Let the community know what you enjoy playing and what you want from organised WARDOGS.'],
  ...
  return (
    <>
      <section className="page-hero" style={{ '--hero-image': `url(${images.banner})` }}>
        ...
        <div className="shell"><p className="kicker">Enlistment</p><h1>Join the 44th.<br /><em>Get into the fight.</em></h1><p className="hero-copy">The quickest way into the regiment is through the 44th WARDOGS Discord.</p><div className="actions"><a className="button primary" href={DISCORD_URL} target="_blank" rel="noreferrer">Join Discord ↗</a><a className="button" href={DONATE_URL} target="_blank" rel="noreferrer">Donate on Ko-fi ↗</a></div></div>
      </section>
